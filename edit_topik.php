...
<td>
	...
	<td><input type="text" name="markah" size="5%"
	value="<?php echo $editMARKAH; ?>" /></td>
	<tr>
	<td></td>
	<td> <input type="hidden" name="idtopik" value="<?php
	echo $idTOPIK; ?>"/>
