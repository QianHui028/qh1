...
$dataSoalan=mysqli_query($hubung, "SELECT jenis, COUNT
(idtopik) as 'bil' FROM soalan WHERE idtopik='$info1
[idtopik]' AND jenis='$info1[jenis]'");
...
?></td>
<td align="center"><?php echo date('d-m-Y g:i A', strto-
time($info1['catatan_masa'])); ?></td>
<td align="center"><?php echo $info1['skor']; ?></td>
<td align="center"><?php echo number_format(($info1
['skor']/$bilsoalan)*$markah_Topik); ?>%</td>
</tr>
<?php $no++; } ?>
</table>
</main
