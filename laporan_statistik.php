...
<p><strong>LAPORAN: BILANGAN SOALAN MENGIKUT TOPIK BAGI SEMUA SUBJEK
</strong></p>

<table width="800" boarder="0" align="center"></td>
</tr>
<tr>
...
while ($infoRekod=mysqli_fetch_array($rekod))
{
	...
	$soalan=mysqli_query($hubung,"SELECT
	idtopik,jenis,COUNT
...
<td align="center"><?php echo><?php echo$infoSoalan['bil'];?></td>
</tr>
<?php $no++;}?>
</table>
