...
//TABLE perekodan
$dataPerekodan=mysqli_query($hubung,"SELECT * FROM
perekodan WHERE idtopik=$getSoalan[idtopik]");
...
WHERE idsoalan='$soalan_terpilih'");
$hapuskan3 = mysqli_query($hubung,"DELETE FROM perekodan
WHERE idtopik=$getPerekodan(idtopik]");
